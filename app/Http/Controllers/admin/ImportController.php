...
class ImportController extends Controller
{
    ...
    public function importMembership(Request $request)
    {
        if (!empty($request->import_file)) {
            ...
            if ($validator->fails()) {
                ...
                if (!empty($data) && $data->count()) {
                    foreach ($data as $key => $value) {
                        ...
                        $total = !empty($value->total) ? trim($value->total, "$") : 0;
                        ...
                        $insert[] = ['first_name' => $first_name, 'middle_name' => $middle_name, 'last_name' => $last_name, 'year' => '2019', 'jan_fees' => $jan_fees, 'feb_fees' => $feb_fees,
            ...
            return back()
                ->withErrors("Import File is Required");
        }
    }
}
